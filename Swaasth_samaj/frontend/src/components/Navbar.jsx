...
export default function Navbar() {
  ...
  // Fetch notifications — only after auth is fully initialized and user is logged in
  useEffect(() => {
    if (loading || !user) { setNotifications([]); return; }
    ...
    const fetchNotifs = async () => {
      try {
        ...
        // Silently ignore auth/network errors for notification polling
      }
    };
