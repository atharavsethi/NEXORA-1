    ...
    <div style={{ minHeight: '100vh', paddingTop: '80px', background: '#f8fafc', paddingBottom: '60px', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        ...
        <p style={{ color: '#64748b', fontSize: '1.05rem', margin: 0 }}>
          Register to join the Swasth Samaj academic and medical forum
        </p>
      </div>
          ...
          <div>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <input type="text" name="name" 
                placeholder="Student Name e.g. Aman Chaudhary" 
          ...
          <div>
            ...
            <div style={{ background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: '10px', padding: '16px', marginBottom: '24px' }}>
              ...
              <p style={{ color: '#1e3a8a', fontSize: '0.9rem', margin: 0 }}>
                Your Student ID will be cross-verified with official databases. Only valid registrations will be approved.
              </p>
            </div>

            <div style={{ marginBottom: '20px' }}>
              <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>Student ID / Roll Number *</label>
              <input type="text" name="studentId" placeholder="e.g., 2023-Med-014" value={formData.studentId} onChange={handleChange}
                style={{ width: '100%', padding: '14px', borderRadius: '10px', border: '1px solid #e2e8f0', fontSize: '1rem', outline: 'none', boxSizing: 'border-box' }} />
            </div>

            <div style={{ marginBottom: '20px' }}>
              <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>College / University Name *</label>
              <input type="text" name="college" placeholder="e.g., AIIMS Delhi" value={formData.college} onChange={handleChange}
                style={{ width: '100%', padding: '14px', borderRadius: '10px', border: '1px solid #e2e8f0', fontSize: '1rem', outline: 'none', boxSizing: 'border-box' }} />
            </div>
            <div style={{ marginBottom: '20px' }}>
              <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>Year of Study</label>
              <input type="text" name="yearOfStudy" placeholder="e.g., 3rd Year MBBS" value={formData.yearOfStudy} onChange={handleChange}
                style={{ width: '100%', padding: '14px', borderRadius: '10px', border: '1px solid #e2e8f0', fontSize: '1rem', outline: 'none', boxSizing: 'border-box' }} />
            </div>

            <div style={{ marginBottom: '30px' }}>
              <label style={{ display: 'block', fontSize: '0.85rem', fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>
                Upload Student ID Card (PDF/Image) *
              </label>
